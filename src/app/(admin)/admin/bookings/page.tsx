...
import {
  Search, Eye, Download, RefreshCw, Calendar,
  Users, CheckCircle, Clock, DollarSign, ChevronRight,
  TrendingUp, Filter, Mail, Phone, Sparkles
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 p-4 space-y-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-600">View and manage turf bookings</p>
        </div>
